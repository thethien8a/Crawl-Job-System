...
def _build_suite(
    ...
    suite = context.suites.add(gx.ExpectationSuite(name="vnworks_suite"))
...
def validate() -> bool:
    ...
    data_source = context.data_sources.add_pandas("vnworks_pandas")
    data_asset = data_source.add_dataframe_asset("vnworks_jobs")
