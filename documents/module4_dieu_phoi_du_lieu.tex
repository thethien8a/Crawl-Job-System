...
% =====================================================================
% Module 4: Dieu phoi du lieu (Orchestration Layer)
% ---------------------------------------------------------------------
% Cach su dung:
%   1. Dat file .tex nay cung thu muc voi bao cao chinh, hoac \input{} no.
%   2. Mo file "module4_diagrams.html" bang trinh duyet, chup man hinh tung
%      bieu do va luu thanh anh (PNG/PDF) dat cung thu muc voi ten:
%      module4_hinh4_1.png  (Luong DAG Airflow)
%      module4_hinh4_2.png  (Kien truc Docker)
%      module4_hinh4_3.png  (Mau DAG Factory)
%   3. Go bo khoi "lstlisting setup" ben duoi neu bao cao da co package
%      "listings" va dinh nghia kieu Python / YAML.
% =====================================================================
